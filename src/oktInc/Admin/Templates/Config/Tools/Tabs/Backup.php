...
<div class="two-cols">
	<div class="col">
		...
		<p><a href="<?php echo $view->generateUrl('config_tools') ?>?make_backup=1" class="icon page_save lazy-load"><?php _e('c_a_tools_backup_perform') ?></a></p>
		...
		<?php foreach ($aBackupFiles as $sBackupFile) : ?>
			<li><a href="<?php echo $view->generateUrl('config_tools') ?>?dl_backup=<?php echo $sBackupFile ?>"><?php echo $sBackupFile ?></a> -
				[<a href="<?php echo $view->generateUrl('config_tools') ?>?delete_backup_file=<?php echo $view->escape($sBackupFile) ?>"
	...
	<div class="col">
		...
		<p><a href="<?php echo $view->generateUrl('config_tools') ?>?make_db_backup=1" class="icon database_save lazy-load"><?php _e('c_a_tools_backup_perform') ?></a></p>
