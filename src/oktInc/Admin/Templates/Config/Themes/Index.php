...
<div class="double-buttonset">
	...
	<div class="buttonsetB">
		<form action="<?php echo $view->generateUrl('config_themes') ?>" method="get" id="search_form" class="search_form">
...
<form action="<?php echo $view->generateUrl('config_themes') ?>" method="get" id="filters-form">
	<fieldset>
		<?php echo $oFilters->getFiltersFields('<div class="three-cols">%s</div>'); ?>
		<p><input type="submit" name="<?php echo $oFilters->getFilterSubmitName() ?>" value="<?php _e('c_c_action_display') ?>" />
		<a href="<?php echo $view->generateUrl('config_themes') ?>?init_filters=1"><?php _e('c_c_reset_filters') ?></a></p>
	</fieldset>
</form>
...
<div id="themes-list">
	...
	<div id="theme_<?php echo $aTheme['id'] ?>" class="ui-widget ui-helper-reset theme">
		...
		<div class="ui-widget-content ui-corner-bottom">
			...
			$aActions[50] = '<a href="'.$view->generateUrl('config_theme', array('theme_id' => $aTheme['id'])).'" class="button-config">'.__('c_a_themes_config').'</a>';
