...
<fieldset>
	...
	<p class="field"><label for="p_htmlpurifier_disabled"><?php echo form::checkbox('p_htmlpurifier_disabled', 1, $aPageData['values']['htmlpurifier_disabled']) ?>
...
<fieldset>
	...
	form::text('p_log_admin_ttl_months', 3, 255, $view->escape($aPageData['values']['log_admin']['ttl_months']))) ?></label></p>
...
<fieldset>
	...
	<p class="field"><label for="p_news_feed_enabled"><?php echo form::checkbox('p_news_feed_enabled', 1, $aPageData['values']['news_feed']['enabled']) ?>
