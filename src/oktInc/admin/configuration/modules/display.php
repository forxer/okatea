...
<div id="tab-installed">
	<h3><?php _e('c_a_modules_installed_modules') ?> (<?php echo ModulesCollection::pluralizeModuleCount($iNumInstalledModules); ?>)</h3>
...
<div id="tab-add">
	...
	<?php elseif (!empty($aModulesRepositories)) : ?>
		...
		<h5><?php echo html::escapeHTML($repo_name).' ('.ModulesCollection::pluralizeModuleCount(count($modules)).')'; ?></h5>
