...
<div class="two-cols">
	<div class="col">
		...
		<p><a href="configuration.php?action=tools&amp;make_backup=1" class="link_sprite ss_page_save lazy-load"><?php _e('c_a_tools_backup_perform') ?></a></p>
	...
	<div class="col">
		...
		<p><a href="configuration.php?action=tools&amp;make_db_backup=1" class="link_sprite ss_database_save lazy-load"><?php _e('c_a_tools_backup_perform') ?></a></p>
