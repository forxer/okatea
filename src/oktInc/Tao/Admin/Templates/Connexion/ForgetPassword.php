...
<p><a href="<?php echo $view->generateUrl('login') ?>"><?php _e('c_c_auth_login') ?></a></p>
...
<form action="<?php echo $view->generateUrl('forget_password') ?>" method="post">

	<p class="field"><label for="email"><?php _e('c_c_auth_give_account_email') ?></label>
	<input type="text" id="email" name="email" size="30" maxlength="255"  /></p>
	...
	<a href="<?php echo $view->generateUrl('login') ?>"><?php _e('c_c_action_Go_back') ?></a></p>
</form>
