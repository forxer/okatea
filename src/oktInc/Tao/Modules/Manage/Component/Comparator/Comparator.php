...
namespace Tao\Modules\Manage\Component\Comparator;
...
class Comparator extends ComponentBase
{
	...
	public function file($sFile, $sSourceDir, $sDestDir, $bTestBackup=false, $bOptional=false)
	{
		...
		$sSourceBase = str_replace($this->okt->options->get('root_path'), '', $sSourceDir);
		$sDestBase = str_replace($this->okt->options->get('root_path'), '', $sDestDir);
