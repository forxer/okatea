...
class Menus
{
	...
	public function getItems(array $aParams=array())
	{
		...
		if (($rs = $this->db->select($sQuery, 'Tao\Navigation\Menus\ItemsRecordset')) === false) {
			$rs = new Tao\Navigation\Menus\ItemsRecordset(array());
		}
	...
	public function getItemI18n($iItemId)
	{
		...
		if (($rs = $this->db->select($query)) === false) {
			$rs = new Tao\Database\Recordset(array());
			return $rs;
		}
