...
<p class="modal-box">
	<a class="modal" rel="test_images" title="<?php printf(__('c_c_Example_%s'), 1) ?>" href="<?php echo $okt->options->public_url ?>/img/sample/chutes_la_nuit.jpg">
	<img width="60" height="60" alt="" src="<?php echo $okt->options->public_url ?>/img/sample/sq-chutes_la_nuit.jpg"/></a>

	<a class="modal" rel="test_images" title="<?php printf(__('c_c_Example_%s'), 2) ?>" href="<?php echo $okt->options->public_url ?>/img/sample/les_chutes.jpg">
	<img width="60" height="60" alt="" src="<?php echo $okt->options->public_url ?>/img/sample/sq-les_chutes.jpg"/></a>

	<a class="modal" rel="test_images" title="<?php printf(__('c_c_Example_%s'), 3) ?>" href="<?php echo $okt->options->public_url ?>/img/sample/chutes.jpg">
...
<form action="module.php" method="post">
	...
	<fieldset>
		...
		<p class="field col"><label><?php echo form::checkbox('p_titleShow',1,$okt->lbl_fancybox->config->titleShow) ?>
		<?php _e('m_lbl_fancybox_show_title') ?></label></p>

		<p class="field col"><label for="p_titlePosition"><?php _e('m_lbl_fancybox_show_title') ?></label>
	...
	<fieldset>
		...
		<div class="three-cols">
		<p class="field col"><label><?php echo form::checkbox('p_overlayShow',1,$okt->lbl_fancybox->config->overlayShow) ?>
		<?php _e('m_lbl_fancybox_show_background') ?></label></p>

		<p class="field col"><label for="p_overlayOpacity"><?php _e('m_lbl_fancybox_background_opacity') ?></label>
		<?php echo form::text('p_overlayOpacity', 10, 255, html::escapeHTML($okt->lbl_fancybox->config->overlayOpacity)) ?></p>

		<p class="field col"><label for="p_overlayColor"><?php _e('m_lbl_fancybox_background_color') ?></label>
		#<?php echo form::text('p_overlayColor', 10, 255, html::escapeHTML($okt->lbl_fancybox->config->overlayColor)) ?></p>

		<p class="field col"><label><?php echo form::checkbox('p_hideOnOverlayClick',1,$okt->lbl_fancybox->config->hideOnOverlayClick) ?>
		<?php _e('m_lbl_fancybox_close_on_bg_click') ?></label></p>
	...
	<fieldset>
		...
		<div class="three-cols">
		<p class="field col"><label><?php echo form::checkbox('p_cyclic',1,$okt->lbl_fancybox->config->cyclic) ?>
		<?php _e('m_lbl_fancybox_slideswhow_cycle') ?></label></p>
		</div>

		<div class="three-cols">
		<p class="field col"><label for="p_transitionIn"><?php _e('m_lbl_fancybox_transition_in') ?></label>
		<?php echo form::select('p_transitionIn',$aTransitions,$okt->lbl_fancybox->config->transitionIn)?></p>

		<p class="field col"><label for="p_speedIn"><?php _e('m_lbl_fancybox_speed_in') ?></label>
		<?php echo form::text('p_speedIn', 10, 255, html::escapeHTML($okt->lbl_fancybox->config->speedIn)) ?></p>
		</div>

		<div class="three-cols">
		<p class="field col"><label for="p_transitionOut"><?php _e('m_lbl_fancybox_transition_out') ?></label>
		<?php echo form::select('p_transitionOut',$aTransitions,$okt->lbl_fancybox->config->transitionOut)?></p>

		<p class="field col"><label for="p_speedOut"><?php _e('m_lbl_fancybox_speed_out') ?></label>
	...
	<fieldset>
		...
		<p class="field"><label><?php echo form::checkbox('p_hideOnContentClick',1,$okt->lbl_fancybox->config->hideOnContentClick) ?>
		<?php _e('m_lbl_fancybox_close_on_content_click') ?></label></p>
