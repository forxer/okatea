	...
	<div id="tabered">
		...
		<div id="tab_images">
			...
			<fieldset>
				...
				<?php else : ?>
					<p><span class="span_sprite ss_error"></span><?php _e('m_news_display_no_interface_display_images') ?>
					<?php echo form::hidden('p_lightbox_type', 0) ?></p>
				<?php endif; ?>

				<p class="modal-box">
					<a class="modal" rel="test_images" title="<?php _e('m_news_display_example_1') ?>" href="<?php echo OKT_COMMON_URL ?>/img/sample/chutes_la_nuit.jpg">
					<img width="60" height="60" alt="" src="<?php echo OKT_COMMON_URL ?>/img/sample/sq-chutes_la_nuit.jpg"/></a>

					<a class="modal" rel="test_images" title="<?php _e('m_news_display_example_2') ?>" href="<?php echo OKT_COMMON_URL ?>/img/sample/les_chutes.jpg">
					<img width="60" height="60" alt="" src="<?php echo OKT_COMMON_URL ?>/img/sample/sq-les_chutes.jpg"/></a>

					<a class="modal" rel="test_images" title="<?php _e('m_news_display_example_3') ?>" href="<?php echo OKT_COMMON_URL ?>/img/sample/chutes.jpg">
