 ...
 * @brief La classe principale du module News.
 *
 */
...
class module_news extends oktModule
{
	...
	protected function prepend_admin()
	{
		...
		{
			$this->okt->page->newsSubMenu = new htmlBlockList(null,adminPage::$formatHtmlSubMenu);
	...
	/**
	 * Retourne sous forme de liste HTML les articles d'une catégorie donnée.
	 *
