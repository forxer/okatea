...
$GLOBALS['__l10n']['m_news_config_install_users'] = 'You must install and enable "User" module to use group permissions';
$GLOBALS['__l10n']['m_news_config_enable_group_permissions'] = 'Enable independent group permissions on posts';

$GLOBALS['__l10n']['m_news_config_rich_text_editor'] = 'Rich text editor';
$GLOBALS['__l10n']['m_news_config_no_rich_text_editor'] = 'There is no rich text editor available';

$GLOBALS['__l10n']['m_news_config_categories_enable'] = 'Enable categories';
$GLOBALS['__l10n']['m_news_config_categories_desc_enable'] = 'Enable descriptions on categories';

$GLOBALS['__l10n']['m_news_config_images'] = 'Images';

$GLOBALS['__l10n']['m_news_config_other_files'] = 'Other files';
$GLOBALS['__l10n']['m_news_config_enable_attached_files'] = 'Enable attached files';
$GLOBALS['__l10n']['m_news_config_num_attached_files'] = 'Number of attached files';
$GLOBALS['__l10n']['m_news_config_extensions_list_allowed'] = 'List of allowed extensions separated by commas';

$GLOBALS['__l10n']['m_news_config_tab_tpl'] = 'Templates';
$GLOBALS['__l10n']['m_news_config_tab_tpl_title'] = 'Templates display';

$GLOBALS['__l10n']['m_news_config_tpl_list'] = 'Posts list templates';
