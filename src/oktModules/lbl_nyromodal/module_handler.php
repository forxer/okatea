...
class module_lbl_nyromodal extends oktModule
{
	public $config = null;
	...
	protected function prepend()
	{
		...
		$this->okt->page->addLbl('nyromodal','nyroModal',array('module_lbl_nyromodal','nyromodal'),self::$jsLoader);
	}
	...
	protected function prepend_admin()
	{
		...
		if (!defined('OKT_DISABLE_MENU'))
		{
			$this->okt->page->configSubMenu->add(
				...
				'module.php?m=lbl_nyromodal&amp;action=config',
				ON_LBL_NYROMODAL_MODULE && ($this->okt->page->action === 'config'),
				25,
				$this->okt->checkPerm('nyromodal_config'),
				null
			);
		}
	}
