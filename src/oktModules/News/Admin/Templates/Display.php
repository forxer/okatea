	...
	<div id="tabered">
		...
		<div id="tab_public">
			...
			<fieldset>
				...
				<?php echo form::select('p_public_default_order_by', $aFieldChoiceOrderBy, $okt->News->config->public_default_order_by) ?></p>

				<p class="field col"><label for="p_public_default_order_direction"><?php _e('m_news_display_public_display_direction') ?></label>
				<?php echo form::select('p_public_default_order_direction', $aFieldChoiceOrderDirection, $okt->News->config->public_default_order_direction) ?></p>
		...
		<div id="tab_admin">
			...
			<fieldset>
				...
				<?php echo form::select('p_admin_default_order_by', $aFieldChoiceOrderBy, $okt->News->config->admin_default_order_by) ?></p>

				<p class="field col"><label for="p_admin_default_order_direction"><?php _e('m_news_display_admin_display_direction') ?></label>
				<?php echo form::select('p_admin_default_order_direction', $aFieldChoiceOrderDirection, $okt->News->config->admin_default_order_direction) ?></p>
		...
		<div id="tab_images">
			...
			<fieldset>
				...
				<p class="modal-box">
					<a class="modal" rel="test_images" title="<?php _e('m_news_display_example_1') ?>" href="<?php echo $okt->options->public_url ?>/img/sample/chutes_la_nuit.jpg">
					<img width="60" height="60" alt="" src="<?php echo $okt->options->public_url ?>/img/sample/sq-chutes_la_nuit.jpg"/></a>

					<a class="modal" rel="test_images" title="<?php _e('m_news_display_example_2') ?>" href="<?php echo $okt->options->public_url ?>/img/sample/les_chutes.jpg">
					<img width="60" height="60" alt="" src="<?php echo $okt->options->public_url ?>/img/sample/sq-les_chutes.jpg"/></a>

					<a class="modal" rel="test_images" title="<?php _e('m_news_display_example_3') ?>" href="<?php echo $okt->options->public_url ?>/img/sample/chutes.jpg">
