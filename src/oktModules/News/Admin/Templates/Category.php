	...
	$okt->page->addButton('newsCatsBtSt', array(
		...
		'ui-icon' => 'plusthick'
			...
			$okt->page->addButton('newsCatsBtSt', array(
				...
				'url' 			=> $okt->router->generate('newsCategory', array('slug' => $aCategoryData['locales'][$okt->user->language]['slug']), null, true),
				'ui-icon' 		=> 'extlink'
			));
}
...
<form action="<?php echo !empty($aCategoryData['cat']['id']) ? $view->generateUrl('News_category', array('category_id' => $aCategoryData['cat']['id'])) : $view->generateUrl('News_category_add'); ?>" method="post">
	...
	<div id="tabered">
		...
		<div id="tab_category">
			...
			<?php echo form::text(array('p_title['.$aLanguage['code'].']','p_title_'.$aLanguage['code']), 60, 255, html::escapeHTML($aCategoryData['locales'][$aLanguage['code']]['title'])) ?></p>
		...
		<div id="tab_seo">
			...
			<?php echo form::text(array('p_title_tag['.$aLanguage['code'].']','p_title_tag_'.$aLanguage['code']), 60, 255, html::escapeHTML($aCategoryData['locales'][$aLanguage['code']]['title_tag'])) ?></p>
			...
			<?php echo form::text(array('p_meta_description['.$aLanguage['code'].']','p_meta_description_'.$aLanguage['code']), 60, 255, html::escapeHTML($aCategoryData['locales'][$aLanguage['code']]['meta_description'])) ?></p>
			...
			<?php echo form::text(array('p_title_seo['.$aLanguage['code'].']','p_title_seo_'.$aLanguage['code']), 60, 255, html::escapeHTML($aCategoryData['locales'][$aLanguage['code']]['title_seo'])) ?></p>
			...
			<?php echo form::textarea(array('p_meta_keywords['.$aLanguage['code'].']','p_meta_keywords_'.$aLanguage['code']), 58, 5, html::escapeHTML($aCategoryData['locales'][$aLanguage['code']]['meta_keywords'])) ?></p>
			...
			<div class="lockable" lang="<?php echo $aLanguage['code'] ?>">
				...
				<?php echo form::text(array('p_slug['.$aLanguage['code'].']','p_slug_'.$aLanguage['code']), 60, 255, html::escapeHTML($aCategoryData['locales'][$aLanguage['code']]['slug'])) ?>
...
<form action="<?php echo !empty($aCategoryData['cat']['id']) ? $view->generateUrl('News_category', array('category_id' => $aCategoryData['cat']['id'])) : $view->generateUrl('News_category_add'); ?>" method="post">
	<div id="tab_siblings">
		...
		while ($aCategoryData['extra']['rsSiblings']->fetch()) : ?>
			...
			<?php echo html::escapeHTML($aCategoryData['extra']['rsSiblings']->title) ?></label>
