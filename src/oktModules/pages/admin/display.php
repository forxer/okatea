	...
	<div id="tabered">
		...
		<div id="tab_images">
			...
			<fieldset>
				...
				<p class="modal-box">
					<a class="modal" rel="test_images" title="<?php _e('m_pages_display_example_1') ?>" href="<?php echo $okt->options->public_url ?>/img/sample/chutes_la_nuit.jpg">
					<img width="60" height="60" alt="" src="<?php echo $okt->options->public_url ?>/img/sample/sq-chutes_la_nuit.jpg"/></a>

					<a class="modal" rel="test_images" title="<?php _e('m_pages_display_example_2') ?>" href="<?php echo $okt->options->public_url ?>/img/sample/les_chutes.jpg">
					<img width="60" height="60" alt="" src="<?php echo $okt->options->public_url ?>/img/sample/sq-les_chutes.jpg"/></a>

					<a class="modal" rel="test_images" title="<?php _e('m_pages_display_example_3') ?>" href="<?php echo $okt->options->public_url ?>/img/sample/chutes.jpg">
