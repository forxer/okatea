...
//		$this->config = $this->okt->newConfig('conf_wymeditor');
	...
	{
		$this->okt->page->addRte('wymeditor','WYMeditor',array('module_rte_wymeditor','wymeditor'));
	}
...
//			'stylesheet' => 'styles.css',
			'skin' => 'compact',
			'updateSelector' => 'input:submit.button', /** @TODO : ce selecteur n'est pas bon ! trop général */
			'updateEvent' => 'click',
			'plain/text' => '
