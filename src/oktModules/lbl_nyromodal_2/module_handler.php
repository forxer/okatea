...
class module_lbl_nyromodal_2 extends Module
{
	...
	protected function prepend()
	{
		...
		$this->okt->page->addLbl('nyromodal2','nyroModal2',array('module_lbl_nyromodal_2','nyromodal2'),self::$jsLoader);
	}
	...
	protected function prepend_admin()
	{
		...
		if (!defined('OKT_DISABLE_MENU'))
		{
			$this->okt->page->configSubMenu->add(
				__('m_lbl_nyromodal_2_menu_config'),
				'module.php?m=lbl_nyromodal_2&amp;action=config',
				ON_LBL_NYROMODAL_2_MODULE && ($this->okt->page->action === 'config'),
				25,
				$this->okt->checkPerm('nyromodal_2_config'),
				null
			);
		}
	}
