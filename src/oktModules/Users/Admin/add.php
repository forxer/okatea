...
if (!empty($_POST['add_user']))
{
	...
	if ($okt->error->isEmpty() && ($new_id = $okt->users->addUser($add_params)) !== false)
	{
		...
		$okt->page->flash->success(__('m_users_user_added'));
...
<form id="add-user-form" action="module.php" method="post">
	<fieldset>
		...
		<div class="three-cols">
			...
			<p class="field col"><label for="add_active"><?php echo form::checkbox('add_active', 1, $add_active) ?> <?php _e('c_c_status_Active') ?></label></p>
		</div>
