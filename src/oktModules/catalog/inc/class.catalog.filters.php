...
class catalogFilters extends FiltersBase
{
	protected $catalog;
	...
	protected function setFilterVisibility()
	{
		...
		$this->fields['visibility'] = array(
			...
			form::select(
				...
				array_merge(array('toutes visibilités'=>-1),module_catalog::getProdsStatuses(true)),
	...
	protected function setFilterCategory()
	{
		...
		$sField =
		'<select id="'.$this->form_id.'_category_id" name="category_id">'.
	...
	protected function setFilterPromo()
	{
		...
		$this->fields['promo'] = array(
			...
			form::checkbox(
				array('promo',$this->form_id.'_promo'),
				1,
				$this->get_catalog_params['promo'],
				$this->getActiveClass('promo'))
		);
	}
	...
	protected function setFilterNouvo()
	{
		...
		$this->fields['nouvo'] = array(
			...
			form::checkbox(
				array('nouvo',$this->form_id.'_nouvo'),
				1,
				$this->get_catalog_params['nouvo'],
				$this->getActiveClass('nouvo'))
		);
	}
	...
	protected function setFilterFavo()
	{
		...
		$this->fields['favo'] = array(
			...
			form::checkbox(
				array('favo',$this->form_id.'_favo'),
				1,
				$this->get_catalog_params['favo'],
				$this->getActiveClass('favo'))
		);
	}
