...
<div class="note">
	...
	<code><?php echo $view->escape('<?php echo $okt->navigation->render('.$iMenuId.') ?>') ?></code></p>
	<p><?php _e('c_a_config_navigation_menu_usage_by_title') ?><br />
	<code><?php echo $view->escape('<?php echo $okt->navigation->render(\''.$aMenuData['title'].'\') ?>') ?></code> </p>
</div>
<?php endif; ?>
