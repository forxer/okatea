...
(function($){
	$.fn.oktClassFocus = function(options) {
		var defaults = {
			className: 'formfocus'
		};
		...
		return this.each(function(){
			...
			.blur(function(){
				jQuery(this).removeClass(opts.className);
			});
		});
	};
})(jQuery);
...
(function ($) {
	$.fn.styleTable = function() {
		...
		return this.each(function () {
			...
			input.find("thead").addClass("ui-widget-header");

			input.find("tbody").on('mouseover mouseout', 'tr', function (event) {
