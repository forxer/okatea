...
# title tag
$okt->page->addTitleTag(__('c_c_auth_login') . ' / ' . __('c_c_auth_register'));

# titre de la page
$okt->page->setTitle(__('c_c_auth_login') . ' / ' . __('c_c_auth_register'));

# titre SEO de la page
$okt->page->setTitleSeo(__('c_c_auth_login') . ' / ' . __('c_c_auth_register'));
...
# fil d'ariane
$okt->page->breadcrumb->add(__('c_c_auth_login') . ' / ' . __('c_c_auth_register'), '');
...
<?php 
# début Okatea : validation JS des formulaires
	...
	<div class="one-third">
		<form id="login-form" class="userform"
			...
			<fieldset>
				...
				<p class="field">
					<label for="user_pwd" title="<?php _e('c_c_required_field') ?>"
				...
				<p>
					<input type="hidden" name="redirect"
						value="<?php echo rawurlencode($redirect) ?>" /> <input
						type="hidden" name="sended" value="1" /> <input class="submit"
						type="submit" value="<?php _e('c_c_auth_login_action') ?>" />
				</p>
			</fieldset>
		...
		<form id="register-form" class="userform"
			...
			<fieldset>
				...
				<div class="two-cols">
					<p class="field col">
						<label for="add_username"
							title="<?php _e('c_c_required_field') ?>" class="required"><?php _e('c_c_user_Username') ?></label>
				...
				<div class="two-cols">
					<p class="field col">
						<label for="add_password"
							title="<?php _e('c_c_required_field') ?>" class="required"><?php _e('c_c_user_Password') ?></label>
				...
				<input type="submit" class="submit"
						value="<?php _e('c_c_auth_register_action') ?>" />
				</p>
			</fieldset>
		</form>
