...
$GLOBALS['okt_l10n']['c_c_emails_details_of_account_are'] = 'Les détails de votre compte sont :';
$GLOBALS['okt_l10n']['c_c_emails_Username_%s'] = 'Nom d’utilisateur : %s';
$GLOBALS['okt_l10n']['c_c_emails_Password_%s'] = 'Mot de passe : %s';
...
$GLOBALS['okt_l10n']['c_c_emails_request_new_password_on_%s'] = 'Vous avez demandé à obtenir un nouveau mot de passe assigné à votre compte sur %s (%s).';
$GLOBALS['okt_l10n']['c_c_emails_request_new_password_not_requested'] = 'Si vous n’en avez pas fait la demande ou ne voulez pas en changer, veuillez ignorer ce message.';
...
$GLOBALS['okt_l10n']['c_c_emails_do_not_reply'] = 'Merci de ne pas répondre à ce message, votre réponse serait perdue.';
