...
<form action="configuration.php" method="post">
	...
	<div class="two-cols">
		<p class="field col">
			<label for="p_filename"><?php _e('c_a_te_filename') ?></label>
		<?php echo form::text('p_filename', 40, 256) ?></p>

		<p class="field col">
			<label for="p_parent"><?php _e('c_a_te_parent_dir') ?></label> <select
				name="p_parent" id="p_parent">
				<option value="/">&nbsp;</option>
			<?php
			
$oThemeEditor->loadThemeDirTree();
