...
<form action="configuration.php" method="post">
	...
	<div class="two-cols">
		<p class="field col">
			<label for="p_tpl_name"><?php _e('c_a_te_tpl_name') ?></label>
		<?php echo form::text('p_tpl_name', 40, 256, $p_tpl_name) ?></p>

		<p class="field col">
			<label for="p_tpl_id"><?php _e('c_a_te_tpl_id') ?></label>
		<?php echo form::text('p_tpl_id', 40, 256, $p_tpl_id) ?></p>

		<p class="field col">
			<label for="p_tpl_desc"><?php _e('c_a_te_tpl_desc') ?></label>
		<?php echo form::text('p_tpl_desc', 60, 256, $p_tpl_desc) ?></p>

		<p class="field col">
			<label for="p_tpl_version"><?php _e('c_a_te_tpl_version') ?></label>
		<?php echo form::text('p_tpl_version', 40, 256, $p_tpl_version) ?></p>

		<p class="field col">
			<label for="p_tpl_author"><?php _e('c_a_te_tpl_author') ?></label>
		<?php echo form::text('p_tpl_author', 40, 256, $p_tpl_author) ?></p>

		<p class="field col">
			<label for="p_tpl_tags"><?php _e('c_a_te_tpl_tags') ?></label>
