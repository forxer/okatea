...
class Module extends BaseModule
{
	...
	protected function prepend_admin()
	{
		...
		if ($this->okt->page->display_menu)
		{
			...
			$this->okt->page->mainMenu->add($this->getName(), $this->okt['adminRouter']->generate('Contact_index'), $this->okt['request']->attributes->get('_route') === 'Contact_index', 2000, $this->okt->checkPerm('contact_usage'), null, $this->okt->page->contactSubMenu, $this->okt['public_url'] . '/modules/' . $this->id() . '/module_icon.png');
