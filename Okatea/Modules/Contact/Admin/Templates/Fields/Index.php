...
$okt->page->js->addReady('
	$("#sortable").sortable({
		...
		update: function(event, ui) {
			...
			$.ajax({
				data: result,
				url: "' . $view->generateAdminUrl('Contact_fields') . '?ajax_update_order=1",
...
<form action="<?php echo $view->generateAdminUrl('Contact_fields') ?>"
	...
	<li id="ord_<?php echo $rsFields->id; ?>"
			...
			<div class="col">
				<label for="p_order_<?php echo $rsFields->id ?>"> <span
			...
			<div class="col right">
				...
				<a
					href="<?php echo $view->generateAdminUrl('Contact_field', array('field_id' => $rsFields->id)) ?>"
					...
					href="<?php echo $view->generateAdminUrl('Contact_field_values', array('field_id' => $rsFields->id)) ?>"
			...
			<?php else : ?>
			- <a
					href="<?php echo $view->generateAdminUrl('Contact_fields') ?>?delete=<?php echo $rsFields->id ?>"
