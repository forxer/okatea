...
<form action="<?php echo $view->generateUrl('Contact_fields') ?>"
	...
	<li id="ord_<?php echo $rsFields->id; ?>"
			...
			<div class="col right">
				...
				<a
					href="<?php echo $view->generateUrl('Contact_field', array('field_id' => $rsFields->id)) ?>"
					...
					href="<?php echo $view->generateUrl('Contact_field_values', array('field_id' => $rsFields->id)) ?>"
			...
			<?php else : ?>
			- <a
					href="<?php echo $view->generateUrl('Contact_fields') ?>?delete=<?php echo $rsFields->id ?>"
