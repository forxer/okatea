...
<div class="two-cols">
	...
	<p class="field col" lang="<?php echo $aLanguage['code'] ?>">
		<label for="field_title_<?php echo $aLanguage['code'] ?>"
			title="<?php _e('c_c_required_field') ?>" class="required"><?php $okt['languages']->hasUniqueLanguage() ? _e('m_contact_field_title') : printf(__('m_contact_field_title_in_%s'), $aLanguage['title']) ?> <span
...
<div class="two-cols">
	<?php foreach ($okt['languages']->getList() as $aLanguage) : ?>
	<p class="field col" lang="<?php echo $aLanguage['code'] ?>">
		<label for="field_description_<?php echo $aLanguage['code'] ?>"><?php $okt['languages']->hasUniqueLanguage() ? _e('m_contact_field_description') : printf(__('m_contact_field_description_in_%s'), $aLanguage['title']) ?> <span
			class="lang-switcher-buttons"></span></label>
