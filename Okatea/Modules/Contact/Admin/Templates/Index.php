...
<form action="<?php $view->generateAdminUrl('Contact_index') ?>"
	...
	<h3><?php _e('m_contact_recipients') ?></h3>
		...
		<p class="field">
		<label for="p_recipients_to_<?php echo $iLineCount ?>"><?php printf(__('m_contact_recipients_recipient_%s'), $iLineCount) ?></label>
		<?php echo form::text(array('p_recipients_to[]','p_recipients_to_'.$iLineCount), 60, 255, $view->escape($sRecipient)) ?></p>

		<?php endforeach; ?>

		<p class="field">
		<label for="p_recipients_to_<?php echo ($iLineCount+1) ?>"><?php _e('m_contact_recipients_add_recipient') ?></label>
	...
	<h3><?php _e('m_contact_recipients_copy') ?></h3>
		...
		<p class="field">
		<label for="p_recipients_cc_<?php echo $iLineCount ?>"><?php printf(__('m_contact_recipients_copy_%s'), $iLineCount) ?></label>
		<?php echo form::text(array('p_recipients_cc[]', 'p_recipients_cc_'.$iLineCount), 60, 255, $view->escape($sRecipient)) ?></p>

		<?php endforeach; ?>

		<p class="field">
		<label for="p_recipients_cc_<?php echo ($iLineCount+1) ?>"><?php _e('m_contact_recipients_add_copy') ?></label>
	...
	<h3><?php _e('m_contact_recipients_hidden_copy')?></h3>
		...
		<p class="field">
		<label for="p_recipients_bcc_<?php echo $iLineCount ?>"><?php printf(__('m_contact_recipients_hidden_copy_%s'), $iLineCount) ?></label>
		<?php echo form::text(array('p_recipients_bcc[]', 'p_recipients_bcc_'.$iLineCount), 60, 255, $view->escape($sRecipient)) ?></p>

		<?php endforeach; ?>

		<p class="field">
		<label for="p_recipients_bcc_<?php echo ($iLineCount+1) ?>"><?php _e('m_contact_recipients_add_hidden_copy') ?></label>
