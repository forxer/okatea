	...
	<div id="tabered">
		...
		<div id="tab_general">
			...
			<?php if ($okt->page->hasCaptcha()) : ?>
				<p class="field"><label for="p_captcha"><?php _e('m_contact_config_Captcha') ?></label>
			...
			<fieldset>
				...
				<p class="field"><label for="p_email_color"><?php echo __('m_contact_config_email_color') ?></label>
				<?php echo form::text('p_email_color', 10, 7, $okt->module('Contact')->config->email_color) ?></p>

				<p class="field"><label for="p_email_color"><?php echo __('m_contact_config_email_font_size') ?></label>
				<select name="p_email_size" id="p_email_size">
					<?php for($i=8; $i<=16; $i++) : ?>
					<option value="<?php echo $i; ?>" <?php if ($okt->module('Contact')->config->email_size == $i) : ?>selected="selected"<?php endif; ?>><?php echo $i; ?> px</option>
					<?php endfor; ?>
				</select></p>
			</fieldset>
