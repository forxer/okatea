	...
	<div id="tabered">
		...
		<div id="tab_general">
			...
			<fieldset>
				...
				<p class="field">
					<label><?php echo form::checkbox('p_enable_metas',1,$okt->diary->config->enable_metas)?>
				<?php _e('c_c_enable_seo_help') ?></label>
				</p>

				<p class="field">
					<label><?php echo form::checkbox('p_enable_filters',1,$okt->diary->config->enable_filters)?>
				Afficher les filtres sur la partie publique</label>
				</p>

			<?php if ($okt->page->hasRte()) : ?>
				<p class="field">
					<label for="p_enable_rte">Éditeur de texte riche</label>
		...
		<div id="tab_fields">
			...
			<p class="field col">
				<label for="p_chp_color"><?php _e('m_diary_tab_options_color') ?></label>
			<?php echo form::select('p_chp_color', $aFieldChoices, $okt->diary->config->fields['color']) ?></p>

			<p class="field col">
				<label for="p_chp_disponibility"><?php _e('m_diary_tab_options_disponibility') ?></label>
		...
		<div id="tab_files">
			...
			<fieldset>
				...
				<p class="field">
					<label><?php echo form::checkbox('p_enable_files',1,$okt->diary->config->files['enable'])?>
