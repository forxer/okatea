...
class DiaryFilters extends BaseFilters
{
	 ...
	 * @return string
	 */
	public function getFiltersFields($bloc_format = '<div class="three-cols">%s</div>', $item_format = '<p class="col field"><label for="%s">%s</label>%s</p>')
	{
		$return = '';
	 ...
	 * @return string
	 */
	public function getFiltersFieldsDate($bloc_format = '<div class="two-cols">%s</div>', $item_format = '<p class="col field"><label for="%s">%s</label>%s</p>')
	{
		$return = '';
