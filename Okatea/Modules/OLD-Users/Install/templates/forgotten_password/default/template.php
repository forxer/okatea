...
<?php 
# si le mot de passe a été envoyé on l'indique
if ($password_sended)
:
	?>
...
<p>
	<a href="<?php echo $view->escape(UsersHelpers::getLoginUrl()) ?>"><?php _e('c_c_auth_login') ?></a>
</p>


<?php 
# si le mot de passe a été mis à jour on l'indique
...
<form id="forget-password-form" class="userform"
	action="<?php echo $view->generateUrl('usersForgetPassword') ?>"
	method="post">
	...
	<p>
		<input type="hidden" name="form_sent" value="1" /> <input
			class="submit" type="submit" value="<?php _e('c_c_action_Send') ?>" />
	</p>
