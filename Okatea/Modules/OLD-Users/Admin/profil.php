...
if (! empty($_REQUEST['delete_cookies']))
{
	...
	$okt['flashMessages']->success(__('m_users_cookies_has_been_deleted'));
...
if (! empty($_POST['change_password']) && $okt['visitor']->checkPerm('change_password'))
{
	...
	$okt['flashMessages']->success(__('m_users_profile_edited'));
...
<div id="tabered">
	...
	<div id="tab-user-profil">
		...
		<p>
			<a href="?logout=1"><?php _e('c_c_user_Log_off_action') ?></a>
		</p>
