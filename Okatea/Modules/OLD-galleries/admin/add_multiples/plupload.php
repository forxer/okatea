...
if (! empty($_POST['sended']))
{
	...
	$okt['flashMessages']->success(__('m_galleries_items_added'));
	...
	<div class="two-cols">
		<div id="items-title" class="col">
			...
			<p class="field" lang="<?php echo $aLanguage['code'] ?>">
				<label for="p_title_<?php echo $aLanguage['code'] ?>"><?php $okt['languages']->hasUniqueLanguage() ? _e('m_galleries_plupload_items_title') : printf(__('m_galleries_plupload_items_title_in_%s'),$aLanguage['title']) ?> <span
