	...
	<div id="tabered">
		...
		<div id="tab_public">
			...
			<fieldset>
				...
				<p class="field">
					<label for="p_public_default_nb_per_page">Nombre par défaut de
						produits par page sur la partie publique</label>
			...
			<fieldset>
				...
				<p class="info">Vous pouvez choisir de tronquer les descriptions des
					produits sur les listes de produits et d'afficher un lien "En
					savoir plus".</p>

				<p class="field">
					<label for="p_public_truncat_char">Nombre de caractères avant
						troncature</label>
		...
		<div id="tab_admin">
			...
			<fieldset>
				...
				<p class="field">
					Style d’affichage par défaut des listes de produits sur l’interface
					d’administration <label><span class="icon application_view_list"></span>Liste
					<?php
					
echo form::radio(array(
						'p_admin_dysplay_style'
...
echo form::radio(array(
				...
				<p class="field">
					<label for="p_admin_default_nb_per_page">Nombre par défaut de
						produits par page sur l’interface d’administration</label>
			...
			<fieldset>
				...
				<p class="field">
					Afficher les filtres <label>dans une boite de dialogue <?php echo form::radio(array('p_admin_filters_style'),'dialog',($okt->catalog->config->admin_filters_style=='dialog'))?></label>
...
$aChoices = array_merge(array(
				...
				echo $aChoices[$okt->catalog->config->lightbox_type]?></em>
				</p>
				<?php else : ?>
					<p>
