...
class oktSpamFilter
{
	 ...
	 *
	 * @param
	 *        	type		<b>string</b>		Comment type (comment or trackback)
	 * @param
	 *        	author	<b>string</b>		Comment author
	 * @param
	 *        	email	<b>string</b>		Comment author email
	 * @param
	 *        	site		<b>string</b>		Comment author website
	 * @param
	 *        	ip		<b>string</b>		Comment author IP address
	 * @param
	 *        	content	<b>string</b>		Comment content
	 * @param
	 *        	[out]	status	<b>integer</b>		Comment status
	 * @return <b>boolean</b>
	 */
	 ...
	 *        	content	<b>string</b>		Comment content
	 * @param
	 *        	post_url	<b>string</b>		Post URL
	 * @param
	 *        	rs		<b>record</b>		Comment record
	 * @return <b>boolean</b>
	 */
	 ...
	 * You can overload this method to
	 * return a custom message. Message is shown in comment details and in
	 * comments list.
	 *
	 * @param
	 *        	status		<b>string</b>		Filter status.
	 * @param
	 *        	comment_id	<b>record</b>		Comment record
	 * @return <b>string</b>
	 */
