...
<form action="module.php" method="post" enctype="multipart/form-data">
	<div id="tabered">
		...
		<div id="tab_general">
			...
			<p class="field">
				<label for="p_enable_accessories"><?php echo form::checkbox('p_enable_accessories', 1, $okt->estimate->config->enable_accessories)?>
			<?php _e('m_estimate_config_enable_accessories') ?></label>
			</p>
			...
			<fieldset>
				...
				<?php if ($okt->page->hasCaptcha()) : ?>
					<p class="field">
					<label for="p_captcha"><?php _e('m_estimate_config_choose_captcha') ?></label>
			...
			<fieldset>
				...
				<p class="field">
					<label for="p_enable_notifications"><?php echo form::checkbox('p_enable_notifications', 1, $okt->estimate->config->enable_notifications)?>
				<?php _e('m_estimate_config_enable_notifications') ?></label>
				</p>
			...
			<fieldset>
				...
				<p class="field">
					<label for="p_default_products_number"><?php _e('m_estimate_config_default_products_number') ?></label>
				<?php echo form::text('p_default_products_number', 3, 3, $okt->estimate->config->default_products_number) ?></p>

				<p class="field">
					<label for="p_default_accessories_number"><?php _e('m_estimate_config_default_accessories_number') ?></label>
