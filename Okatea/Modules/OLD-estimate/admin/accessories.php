...
if (! empty($_GET['delete_accessory']))
{
	...
	{
		$okt['flashMessages']->success(__('m_estimate_accessory_deleted'));
...
# Liste des produits
$rsProducts = $okt->estimate->products->getProducts(array(
	'active' => 2
));
$aProducts = array(
	'&nbsp;' => null
...
$count_line = 0;
	...
	<tr>
			<th class="<?php echo $td_class ?> fake-td" scope="row"><a
				href="module.php?m=estimate&amp;action=accessory&amp;accessory_id=<?php echo $rsAccessories->id ?>"><?php
		echo html::escapeHTML($rsAccessories->title)?></a></th>

			<td class="<?php echo $td_class ?>"><a
				href="module.php?m=estimate&action=product&amp;product_id=<?php echo $rsAccessories->product_id ?>"><?php echo html::escapeHTML($rsAccessories->product_title) ?></a>
			</td>
			...
			<td class="<?php echo $td_class ?> small">
				...
				<a
						href="module.php?m=estimate&amp;action=accessories&amp;switch_status=<?php echo $rsAccessories->id ?>"
				...
				<?php endif; ?>
					...
					<li><a
						href="module.php?m=estimate&amp;action=accessory&amp;accessory_id=<?php echo $rsAccessories->id ?>"
					...
					<li><a
						href="module.php?m=estimate&amp;action=accessories&amp;delete_accessory=<?php echo $rsAccessories->id ?>"
