	...
	protected function checkParams()
	{
		if (!empty($this->params))
		{
			...
			if ($this->config->chp_description > 0)
			{
				...
				{
					$this->error->set(sprintf(__('m_partners_error_missing_default_language_description_%s'), $this->okt['languages']->getList()[$this->okt['config']->language]['title']));
				}
			}
			else
			{
			...
			if ($this->config->chp_url > 0)
			{
				...
				{
					$this->error->set(sprintf(__('m_partners_error_missing_default_language_url_%s'), $this->okt['languages']->getList()[$this->okt['config']->language]['title']));
				}
			}
			else
			{
			...
			if ($this->config->chp_url_title > 0)
			{
				...
				{
					$this->error->set(sprintf(__('m_partners_error_missing_default_language_url_title_%s'), $this->okt['languages']->getList()[$this->okt['config']->language]['title']));
				}
			}
			else
			{
