...
class Module extends BaseModule
{
	...
	{
		# permissions
		$this->okt['permissions']->addPerm('rte_tinymce_4_config', __('m_rte_tinymce_4_perm_config'), 'configuration');
	...
	protected function prepend_admin()
	{
		...
		{
			$this->okt->page->configSubMenu->add(__('TinyMCE 4'), $this->okt['adminRouter']->generate('RteTinymce4_config'), $this->okt['request']->attributes->get('_route') === 'RteTinymce4_config', 40, $this->okt['visitor']->checkPerm('rte_tinymce_4_config'), null);
		}
	}
		...
		if ($okt['modules']->isLoaded('media_manager'))
		{
			$aOptions[] = 'file_browser_callback: function (field_name, url, type, win) {
					tinymce.activeEditor.windowManager.open({
						title: "Media manager",
						url: "' . $okt['config']->app_url . 'admin/module.php?m=media_manager&popup=1&editor=1&type=" + type,
						width: 700,
						height: 450
					}, {
