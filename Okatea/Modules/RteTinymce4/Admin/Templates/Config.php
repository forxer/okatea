...
<form action="<?php echo $view->generateUrl('RteTinymce4_config'); ?>" method="post">
	...
	<ul class="checklist">
		<li><?php echo form::radio(array('p_content_css','p_content_css_0'), 0, ($okt->module('RteTinymce4')->config->content_css == 0))?> <label for="p_content_css_0"><?php _e('c_c_none_f') ?></label></li>
