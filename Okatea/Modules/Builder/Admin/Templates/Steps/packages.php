...
<form
	...
	<p><?php _e('m_builder_step_packages_1') ?></p>

	<p class="note">
		<span class="icon clock"></span> <?php _e('m_builder_long_time_note') ?></p>

	<p><?php echo form::hidden('form_sent', 1)?>
	<input type="submit" value="<?php _e('c_c_next') ?>" class="lazy-load" />
	</p>
</form>
