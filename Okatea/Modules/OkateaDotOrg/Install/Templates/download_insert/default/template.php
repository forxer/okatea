...
<div id="download-insert">
	...
	<div class="version">
		...
		<a href="<?php echo $view->escapeHtmlAttr($aStableVersion['href']); ?>">
			<h3><?php _e('Stable') ?></h3>
			<p><strong><?php echo $view->escape($aStableVersion['version']); ?></strong></p>
		</a>
		<?php else : ?>
			<h3><?php _e('Stable') ?></h3>
			<p><abbr title="<?php echo $view->escapeHtmlAttr(__('currently no release')) ?>">-</abbr></p>
		<?php endif; ?>
	</div>
