...
class Module extends BaseModule
{
	...
	protected function prepend_admin()
	{
		...
		$this->okt->page->addRte('tinymce_simple', 'tinyMCE simple', array(
			'Okatea\\Modules\\RteTinymce3\\Module',
			'tinyMCEsimple'
		));
		$this->okt->page->addRte('tinymce_advanced', 'tinyMCE advanced', array(
			'Okatea\\Modules\\RteTinymce3\\Module',
			'tinyMCEadvanced'
		));
		$this->okt->page->addRte('tinymce_experts', 'tinyMCE experts', array(
			'Okatea\\Modules\\RteTinymce3\\Module',
			'tinyMCEexperts'
		));
