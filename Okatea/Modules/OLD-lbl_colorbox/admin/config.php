...
<form action="module.php" method="post">
	...
	<fieldset>
		...
		<p class="field"><label for="p_theme"><?php _e('m_lbl_colorbox_theme') ?></label>
	...
	<fieldset>
		...
		<p class="field col"><label><?php echo form::checkbox('p_loop',1,$okt->lbl_colorbox->config->loop) ?>
		<?php _e('m_lbl_colorbox_loop') ?></label></p>

		<p class="field col"><label for="p_transition"><?php _e('m_lbl_colorbox_transitions_type') ?></label>
		<?php echo form::select('p_transition',$aTransitions,$okt->lbl_colorbox->config->transition)?></p>

		<p class="field col"><label for="p_speed"><?php _e('m_lbl_colorbox_transitions_speed') ?></label>
	...
	<fieldset>
		...
		<div class="three-cols">
		<p class="field col"><label><?php echo form::checkbox('p_slideshow',1,$okt->lbl_colorbox->config->slideshow) ?>
		<?php _e('m_lbl_colorbox_enable_slideshow') ?></label></p>

		<p class="field col"><label><?php echo form::checkbox('p_slideshowauto',1,$okt->lbl_colorbox->config->slideshowauto) ?>
		<?php _e('m_lbl_colorbox_slideshow_autostart') ?></label></p>

		<p class="field col"><label for="p_slideshowspeed"><?php _e('m_lbl_colorbox_slideshow_speed') ?></label>
