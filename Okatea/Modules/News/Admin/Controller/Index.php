...
class Index extends Controller
{
	...
	protected function deletePost()
	{
		...
		if ($this->okt->module('News')->deletePost($iPostId))
		{
			...
			$this->okt['flashMessages']->success(__('m_news_list_post_deleted'));
	...
	protected function selectPost()
	{
		...
		if ($this->okt->module('News')->setPostSelected($iPostId, true))
		{
			...
			$this->okt['flashMessages']->success(__('m_news_list_post_selected'));
	...
	protected function unselectPost()
	{
		...
		if ($this->okt->module('News')->setPostSelected($iPostId, false))
		{
			...
			$this->okt['flashMessages']->success(__('m_news_list_post_deselected'));
	...
	protected function publishPost()
	{
		...
		if ($this->okt->module('News')->publishPost($iPostId))
		{
			...
			$this->okt['flashMessages']->success(__('m_news_list_post_published'));
	...
	protected function batches()
	{
		...
		elseif ($sAction === 'publish')
		{
			...
			$this->okt['flashMessages']->success(__('m_news_list_posts_published'));
		}
		elseif ($sAction === 'selected')
		{
			...
			$this->okt['flashMessages']->success(__('m_news_list_posts_selected'));
		}
		elseif ($sAction === 'unselected')
		{
			...
			$this->okt['flashMessages']->success(__('m_news_list_posts_deselected'));
		}
		elseif ($sAction === 'delete' && $this->okt['visitor']->checkPerm('news_delete'))
		{
			...
			$this->okt['flashMessages']->success(__('m_news_list_posts_deleted'));
		}
