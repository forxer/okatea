...
<p class="field" lang="<?php echo $aLanguage['code'] ?>">
	<label for="p_title_<?php echo $aLanguage['code'] ?>"><?php $okt['languages']->hasUniqueLanguage() ? _e('m_news_post_title') : printf(__('m_news_post_title_in_%s'),$aLanguage['title']) ?> <span
...
<p class="field" lang="<?php echo $aLanguage['code'] ?>">
	<label for="p_subtitle_<?php echo $aLanguage['code'] ?>"><?php $okt['languages']->hasUniqueLanguage() ? _e('m_news_post_subtitle') : printf(__('m_news_post_subtitle_in_%s'),$aLanguage['title']) ?> <span
		class="lang-switcher-buttons"></span></label>
...
<p class="field" lang="<?php echo $aLanguage['code'] ?>">
	<label for="p_content_<?php echo $aLanguage['code'] ?>"><?php $okt['languages']->hasUniqueLanguage() ? _e('m_news_post_content') : printf(__('m_news_post_content_in_%s'),$aLanguage['title']) ?> <span
		class="lang-switcher-buttons"></span></label>
