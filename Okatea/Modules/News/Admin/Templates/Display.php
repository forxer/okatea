	...
	<div id="tabered">
		...
		<div id="tab_public">
			...
			<fieldset>
				...
				<p class="field"><label for="p_public_display_date"><?php echo form::checkbox('p_public_display_date', 1, $okt->module('News')->config->public_display_date) ?>
				<?php _e('m_news_display_show_date') ?></label></p>

				<p class="field"><label for="p_public_display_author"><?php echo form::checkbox('p_public_display_author', 1, $okt->module('News')->config->public_display_author) ?>
		...
		<div id="tab_images">
			...
			<fieldset>
				...
				<?php if ($okt->page->hasLbl()) : ?>
					...
					echo $aChoices[$okt->module('News')->config->lightbox_type] ?></em></p>
				<?php else : ?>
