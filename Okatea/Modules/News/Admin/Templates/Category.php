...
if ($aCategoryData['cat']['id'])
{
	...
	$okt->page->addButton('newsCatsBtSt', array(
		...
		'url' => $view->generateUrl('News_category', array(
		...
		<div id="tab_category">
			...
			<p class="field" lang="<?php echo $aLanguage['code'] ?>">
				<label for="p_title_<?php echo $aLanguage['code'] ?>"
					title="<?php _e('c_c_required_field') ?>" class="required"><?php $okt->languages->unique ? _e('m_news_cat_title') : printf(__('m_news_cat_title_in_%s'),$aLanguage['title']) ?> <span
			...
			<p class="field" lang="<?php echo $aLanguage['code'] ?>">
				<label for="p_content_<?php echo $aLanguage['code'] ?>"><?php $okt->languages->unique ? _e('m_news_cat_desc') : printf(__('m_news_cat_desc_in_%s'),$aLanguage['title']) ?> <span
					class="lang-switcher-buttons"></span></label>
