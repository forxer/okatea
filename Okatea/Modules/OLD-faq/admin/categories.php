...
<div id="tab-edit">
	...
	<p class="field">
				<label><?php echo form::checkbox('edit_active', 1, $edit_active) ?> <?php _e('c_c_action_visible') ?></label>
			</p>
...
$i = 1;
		...
		:
			?>
		<li id="ord_<?php echo $rsCategories->id ?>" class="ui-state-default"><label
					for="order_<?php echo $rsCategories->id ?>"> <span
			...
			- <a
					href="module.php?m=faq&amp;action=categories&amp;switch_status=<?php echo $rsCategories->id ?>"
			...
			- <a
					href="module.php?m=faq&amp;action=categories&amp;do=edit&amp;category_id=<?php echo $rsCategories->id ?>"
					...
					href="module.php?m=faq&amp;action=categories&amp;do=delete&amp;category_id=<?php echo $rsCategories->id ?>"
	...
	<div id="tab-add">
		...
		<p class="field">
				<label><?php echo form::checkbox('add_active', 1, $add_active) ?> <?php _e('c_c_action_visible') ?></label>
			</p>
