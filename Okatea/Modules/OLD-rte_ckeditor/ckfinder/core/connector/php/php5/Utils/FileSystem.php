...
class CKFinder_Connector_Utils_FileSystem
{
	...
	/**
	 * Get file extension (only last part - e.g.
	 * extension of file.foo.bar.jpg = jpg)
	 *
	 * @static
	 *
	 * @access public
	 ...
	 *        	string UTF-8 string
	 * @param
	 *        	string UTF-8 with accented characters replaced by ASCII chars
	 ...
	 *        	client path (with trailing slash)
	 * @param object $_resourceType
