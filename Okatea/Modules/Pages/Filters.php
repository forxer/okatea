...
class Filters extends BaseFilters
{
	...
	protected function setFilterVisibility()
	{
		...
		$this->fields['active'] = array(
			...
			form::select(array(
				...
				__('c_c_All_f') => 2,
				__('c_c_action_Visibles') => 1,
				__('c_c_action_Hiddens_fem') => 0
			), $this->get_pages_params['active'], $this->getActiveClass('active'))
		);
	}
	...
	protected function setFilterLanguage()
	{
		...
		$this->fields['language'] = array(
			...
			), $aSelectLanguagesValues, $this->get_pages_params['language'], $this->getActiveClass('language'))
		);
	}
