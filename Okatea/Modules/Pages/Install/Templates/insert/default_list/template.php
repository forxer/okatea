...
<div id="pages_list_insert">
	...
	<div class="page <?php echo $rsInsertPages->odd_even ?>">
		...
		<h2 class="page-title">
			<a href="<?php echo $view->escapeHtmlAttr($rsInsertPages->url) ?>"><?php echo $view->escape($rsInsertPages->title) ?></a>
		</h2>
		...
		<p class="page-subtitle">
			<strong><?php echo $view->escape($rsInsertPages->subtitle) ?></strong>
		</p>
		...
		:
			...
			<p class="read-more-link-wrapper">
				<a href="<?php echo $view->escape($rsInsertPages->url) ?>"
