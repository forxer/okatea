...
if ($aCategoryData['cat']['id'])
{
	...
	$okt->page->addButton('pagesCatsBtSt', array(
		...
		'url' => $okt['router']->generateFromAdmin('pagesCategory', array(
...
if ($aCategoryData['cat']['id'])
{
	$path = $okt->module('Pages')->categories->getPath($aCategoryData['cat']['id'], true, $okt['visitor']->language);
...
<form
	...
	<div id="tabered">
		...
		<div id="tab_category">
			...
			<p class="field" lang="<?php echo $aLanguage['code'] ?>">
				<label for="p_title_<?php echo $aLanguage['code'] ?>"
					title="<?php _e('c_c_required_field') ?>" class="required"><?php $okt['languages']->hasUniqueLanguage() ? _e('m_pages_cat_title') : printf(__('m_pages_cat_title_in_%s'),$aLanguage['title']) ?> <span
			...
			<p class="field" lang="<?php echo $aLanguage['code'] ?>">
				<label for="p_content_<?php echo $aLanguage['code'] ?>"><?php $okt['languages']->hasUniqueLanguage() ? _e('m_pages_cat_desc') : printf(__('m_pages_cat_desc_in_%s'),$aLanguage['title']) ?> <span
					class="lang-switcher-buttons"></span></label>
		...
		<div id="tab_options">
			...
			<div class="two-cols">
				<p class="field col">
					<label for="p_parent_id"><?php _e('m_pages_cat_parent') ?></label>
			...
			<div class="two-cols">
				...
				<p class="field col">
					<label for="p_tpl"><?php _e('m_pages_cat_tpl') ?></label>
				...
				<p class="field col">
					<label for="p_items_tpl"><?php _e('m_pages_cat_items_tpl') ?></label>
