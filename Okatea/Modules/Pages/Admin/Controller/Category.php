...
class Category extends Controller
{
	...
	public function add()
	{
		...
		if ($this->populateDataFromPost())
		{
			try
			{
				...
				$this->okt['flashMessages']->success(__('m_pages_cat_added'));
	...
	public function edit()
	{
		...
		{
			$this->okt['flashMessages']->error(sprintf(__('m_pages_post_%s_not_exists'), $this->aPostData['post']['id']));
		...
		# rubriques voisines
		$this->aCategoryData['extra']['rsSiblings'] = $this->okt->module('Pages')->categories->getChildren($rsCategory->parent_id, false, $this->okt['visitor']->language);
		...
		if ($this->populateDataFromPost())
		{
			try
			{
				...
				$this->okt['flashMessages']->success(__('m_pages_cat_updated'));
