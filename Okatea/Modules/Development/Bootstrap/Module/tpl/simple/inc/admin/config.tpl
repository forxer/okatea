...
<form action="module.php" method="post">
	<div id="tabered">
		...
		<fieldset>
			...
			<p class="field" lang="<?php echo $aLanguage['code'] ?>"><label for="p_public_url_<?php echo $aLanguage['code'] ?>"><?php printf(__('m_##module_id##_config_url_from_%s'), '<code>'.$okt['request']->getSchemeAndHttpHost().$okt['config']->app_url.($okt['languages']->unique ? '' : $aLanguage['code'].'/').'</code>', html::escapeHTML($aLanguage['title'])) ?><span class="lang-switcher-buttons"></span></label>
