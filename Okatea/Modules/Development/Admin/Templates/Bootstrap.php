	...
	<div id="tab-simple">
		...
		<form class="col"
			...
			<fieldset>
				...
				<div class="two-cols">
					<p class="field col">
						<label for="bootstrap_module_name" class="required"
							title="<?php _e('c_c_required_field') ?>"><?php _e('m_development_bootstrap_en_name'); ?></label>
					<?php echo form::text('bootstrap_module_name', 60, 255, html::escapeHTML($aBootstrapData['name'])); ?></p>

					<p class="field col">
						<label for="bootstrap_module_name_fr" class="required"
							title="<?php _e('c_c_required_field') ?>"><?php _e('m_development_bootstrap_fr_name'); ?></label>
					<?php echo form::text('bootstrap_module_name_fr', 60, 255, html::escapeHTML($aBootstrapData['name_fr'])); ?></p>
				</div>

				<p class="field">
					<label for="bootstrap_module_version" class="required"
						title="<?php _e('c_c_required_field') ?>"><?php _e('Version'); ?></label>
				<?php echo form::text('bootstrap_module_version', 10, 255, html::escapeHTML($aBootstrapData['version'])); ?></p>

				<div class="two-cols">
					<p class="field col">
						<label for="bootstrap_module_description"><?php _e('m_development_bootstrap_en_description'); ?></label>
					<?php echo form::text('bootstrap_module_description', 60, 255, html::escapeHTML($aBootstrapData['description'])); ?></p>

					<p class="field col">
						<label for="bootstrap_module_description_fr"><?php _e('m_development_bootstrap_fr_description'); ?></label>
					<?php echo form::text('bootstrap_module_description_fr', 60, 255, html::escapeHTML($aBootstrapData['description_fr'])); ?></p>
				</div>

				<div class="two-cols">
					<p class="field col">
						<label for="bootstrap_module_author"><?php _e('m_development_bootstrap_author'); ?></label>
					<?php echo form::text('bootstrap_module_author', 60, 255, html::escapeHTML($aBootstrapData['author'])); ?></p>

					<p class="field col">
						<label for="bootstrap_module_licence"><?php _e('m_development_bootstrap_license'); ?></label>
		...
		<form class="col"
			...
			<fieldset>
				...
				<fieldset>
					...
					<div class="two-cols">
						<p class="field col">
							<label for="bootstrap_module_l10n_1_en"><?php _e('m_development_bootstrap_l10n_1_en') ?></label>
						<?php echo form::text('bootstrap_module_l10n_1_en', 60, 255, html::escapeHTML($aBootstrapData['locales']['en'][1])) ?></p>

						<p class="field col">
							<label for="bootstrap_module_l10n_1_fr"><?php _e('m_development_bootstrap_l10n_1_fr') ?></label>
				...
				<fieldset>
					...
					<div class="two-cols">
						<p class="field col">
							<label for="bootstrap_module_l10n_2_en"><?php _e('m_development_bootstrap_l10n_2_en') ?></label>
						<?php echo form::text('bootstrap_module_l10n_2_en', 60, 255, html::escapeHTML($aBootstrapData['locales']['en'][2])) ?></p>

						<p class="field col">
							<label for="bootstrap_module_l10n_2_fr"><?php _e('m_development_bootstrap_l10n_2_fr') ?></label>
				...
				<fieldset>
					...
					<div class="two-cols">
						<p class="field col">
							<label for="bootstrap_module_l10n_3_en"><?php _e('m_development_bootstrap_l10n_3_en') ?></label>
						<?php echo form::text('bootstrap_module_l10n_3_en', 60, 255, html::escapeHTML($aBootstrapData['locales']['en'][3])) ?></p>

						<p class="field col">
							<label for="bootstrap_module_l10n_3_fr"><?php _e('m_development_bootstrap_l10n_3_fr') ?></label>
				...
				<fieldset>
					...
					<div class="two-cols">
						<p class="field col">
							<label for="bootstrap_module_l10n_4_en"><?php _e('m_development_bootstrap_l10n_4_en') ?></label>
						<?php echo form::text('bootstrap_module_l10n_4_en', 60, 255, html::escapeHTML($aBootstrapData['locales']['en'][4])) ?></p>

						<p class="field col">
							<label for="bootstrap_module_l10n_4_fr"><?php _e('m_development_bootstrap_l10n_4_fr') ?></label>
				...
				<fieldset>
					...
					<div class="two-cols">
						<p class="field col">
							<label for="bootstrap_module_l10n_5_en"><?php _e('m_development_bootstrap_l10n_5_en') ?></label>
						<?php echo form::text('bootstrap_module_l10n_5_en',60,255,html::escapeHTML($aBootstrapData['locales']['en'][5])) ?></p>

						<p class="field col">
							<label for="bootstrap_module_l10n_5_fr"><?php _e('m_development_bootstrap_l10n_5_fr') ?></label>
				...
				<fieldset>
					...
					<div class="two-cols">
						<p class="field col">
							<label for="bootstrap_module_l10n_6_en"><?php _e('m_development_bootstrap_l10n_6_en'); ?></label>
						<?php echo form::text('bootstrap_module_l10n_6_en',60,255,html::escapeHTML($aBootstrapData['locales']['en'][6])); ?></p>

						<p class="field col">
							<label for="bootstrap_module_l10n_6_fr"><?php _e('m_development_bootstrap_l10n_6_fr'); ?></label>
				...
				<fieldset>
					...
					<div class="two-cols">
						<p class="field col">
							<label for="bootstrap_module_l10n_7_en"><?php _e('m_development_bootstrap_l10n_7_en'); ?></label>
						<?php echo form::text('bootstrap_module_l10n_7_en',60,255,html::escapeHTML($aBootstrapData['locales']['en'][7])); ?></p>

						<p class="field col">
							<label for="bootstrap_module_l10n_7_fr"><?php _e('m_development_bootstrap_l10n_7_fr'); ?></label>
				...
				<fieldset>
					...
					<div class="two-cols">
						<p class="field col">
							<label for="bootstrap_module_l10n_8_en"><?php _e('m_development_bootstrap_l10n_8_en'); ?></label>
						<?php echo form::text('bootstrap_module_l10n_8_en',60,255,html::escapeHTML($aBootstrapData['locales']['en'][8])); ?></p>

						<p class="field col">
							<label for="bootstrap_module_l10n_8_fr"><?php _e('m_development_bootstrap_l10n_8_fr'); ?></label>
				...
				<fieldset>
					...
					<div class="two-cols">
						<p class="field col">
							<label for="bootstrap_module_l10n_9_en"><?php _e('m_development_bootstrap_l10n_9_en'); ?></label>
						<?php echo form::text('bootstrap_module_l10n_9_en', 60, 255, html::escapeHTML($aBootstrapData['locales']['en'][9])); ?></p>

						<p class="field col">
							<label for="bootstrap_module_l10n_9_fr"><?php _e('m_development_bootstrap_l10n_9_fr'); ?></label>
				...
				<fieldset>
					...
					<div class="two-cols">
						<p class="field col">
							<label for="bootstrap_module_l10n_10_en"><?php _e('m_development_bootstrap_l10n_10_en'); ?></label>
						<?php echo form::text('bootstrap_module_l10n_10_en', 60, 255, html::escapeHTML($aBootstrapData['locales']['en'][10])); ?></p>

						<p class="field col">
							<label for="bootstrap_module_l10n_10_fr"><?php _e('m_development_bootstrap_l10n_10_fr'); ?></label>
				...
				<p class="field">
					<label for="bootstrap_module_l10n_fem"><?php echo form::checkbox('bootstrap_module_l10n_fem', 1, $aBootstrapData['l10n_fem'])?>
				Les éléments sont du genre féminin (par exemple "page")</label>
				</p>
