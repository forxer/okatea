...
class User extends Controller
{
	...
	public function profile()
	{
		...
		if ($this->okt['request']->request->has('form_sent'))
		{
			...
			if (!$this->okt['instantMessages']->hasError())
			{
				...
				{
					$this->okt['flashMessages']->success(__('c_a_users_profil_edited'));
		...
		return $this->render('Users/User/Profile', [
			...
			if (!$this->okt['instantMessages']->hasError())
			{
				if (($iUserId = $this->okt['users']->addUser($this->aPageData['user'])) !== false)
				{
					...
					*/
					...
					$this->okt['flashMessages']->success(__('c_a_users_user_added'));
	...
	public function edit()
	{
		...
		$this->aPageData['tabs'][10] = [
			...
			'content' => $this->renderView('Users/User/Edit/Tabs/General', [
				'aPageData' => $this->aPageData,
				'aLanguages' => $this->getLanguages(),
				'aCivilities' => $this->getCivilities(),
		...
		{
			$this->aPageData['tabs'][100] = [
				'id' => 'tab-change-password',
				'title' => __('c_c_user_Password'),
				'content' => $this->renderView('Users/User/Edit/Tabs/Password', [
					'aPageData' => $this->aPageData
				])
			];
		}
		...
		return $this->render('Users/User/Edit/Page', [
			'aPageData' => $this->aPageData
		]);
	}
	...
	protected function validateUser()
	{
		...
		if ($this->okt['users']->validateUser($this->aPageData['user']['id']))
		{
			...
			$this->okt['flashMessages']->success(__('m_users_validated_user'));
	...
	protected function updateUserPassword()
	{
		...
		if ($this->okt['users']->changeUserPassword($aParams))
		{
			...
			$this->okt['flashMessages']->success(__('c_a_users_user_edited'));
