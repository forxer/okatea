...
class Config extends Controller
{
	...
	protected function init()
	{
		...
		$this->oTemplatesForgottenPassword = new TemplatesSet(
			$this->okt,
			$this->okt->config->users['templates']['forgotten_password'],
		...
		$this->oTemplatesLogin = new TemplatesSet(
			$this->okt,
			$this->okt->config->users['templates']['login'],
			'users/login',
			'login',
			$this->generateUrl('Users_config').'?'
		);
		...
		$this->oTemplatesLoginRegister = new TemplatesSet(
			$this->okt,
			$this->okt->config->users['templates']['login_register'],
		...
		$this->oTemplatesProfile = new TemplatesSet(
			$this->okt,
			$this->okt->config->users['templates']['profile'],
			'users/profile',
			'profile',
			$this->generateUrl('Users_config').'?'
		);
		...
		$this->oTemplatesRegister = new TemplatesSet(
			$this->okt,
			$this->okt->config->users['templates']['register'],
			'users/register',
			'register',
			$this->generateUrl('Users_config').'?'
		);
		...
		$this->oTemplatesUserBar = new TemplatesSet(
			$this->okt,
			$this->okt->config->users['templates']['user_bar'],
			'users/user_bar',
			'user_bar',
			$this->generateUrl('Users_config').'?'
		);
