...
<label for="p_updates_enabled"><?php _e('c_a_config_advanced_enable_update') ?></label></p>

<p class="field"><label for="p_updates_url"><?php _e('c_a_config_advanced_update_url') ?></label>
