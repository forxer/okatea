...
<form id="add-language-form" action="<?php echo $view->generateUrl('config_languages') ?>" method="post">
	...
	<div class="two-cols">
		<p class="field col"><label for="add_language"><?php _e('c_a_config_l10n_language') ?></label>
		<?php echo form::select('add_language', $aLanguagesList, $view->escape($aAddLanguageData['language'])) ?></p>

		<p class="field col"><label for="add_country"><?php _e('c_a_config_l10n_country') ?></label>
