...
<div id="tabered">
	...
	<div id="tab-list">
		...
		<form action="<?php echo $view->generateUrl('config_l10n') ?>" method="post" id="ordering">
			...
			<li id="ord_<?php echo $rsLanguages->id ?>" class="ui-state-default"><label for="p_order_<?php echo $rsLanguages->id ?>">
				...
				<?php else : ?>
				- <a href="<?php echo $view->generateUrl('config_l10n') ?>?enable=<?php echo $rsLanguages->id ?>"
				...
				- <a href="<?php echo $view->generateUrl('config_l10n_edit_language', array('language_id'=>$rsLanguages->id)) ?>"
				...
				- <a href="<?php echo $view->generateUrl('config_l10n') ?>?delete=<?php echo $rsLanguages->id ?>"
	...
	<div id="tab-config">
		<form action="<?php echo $view->generateUrl('config_l10n') ?>" method="post">
