...
<p>
	<span class="icon error"></span> <?php printf(__('c_a_tools_htaccess_not_exists_can_create'), $view->generateUrl('config_tools').'?create_htaccess=1')?></p>
<?php else : ?>

<form id="tool-htaccess-form"
	action="<?php echo $view->generateUrl('config_tools') ?>" method="post">
	<p class="field">
		<label for="p_htaccess_content"><?php _e('c_a_tools_htaccess_content') ?></label>
