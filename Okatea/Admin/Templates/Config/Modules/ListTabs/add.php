...
# Toggle
$okt->page->toggleWithLegend('add_module_zip_title', 'add_module_zip_content', array(
	'cookie' => 'oktAdminAddModuleZip'
));
$okt->page->toggleWithLegend('add_module_repo_title', 'add_module_repo_content', array(
	'cookie' => 'oktAdminAddModuleRepo'
));
	...
	<div id="add_module_zip_content" class="two-cols">
		<form class="col"
			...
			<fieldset>
				...
				<p class="field">
					<label for="pkg_url"><?php _e('c_a_modules_plugin_zip_file_url') ?></label>
			...
			<input type="submit" class="lazy-load"
					value="<?php _e('c_a_modules_download_plugin') ?>" />
			</p>
		</form>
		<form class="col"
			action="<?php echo $view->generateUrl('config_modules') ?>"
			...
			<fieldset>
				...
				<p class="field">
					<label for="pkg_file"><?php _e('c_a_modules_plugin_zip_file') ?></label>
			...
			<?php echo $okt->page->formtoken()?>
			<input type="submit" class="lazy-load"
					value="<?php _e('c_a_modules_upload_plugin') ?>" />
			</p>
		</form>
	</div>
