...
<div id="tabered">
		...
		<table class="common routes_list">
			...
			<tr id="route_<?php echo $sRouteName ?>">
					<th class="<?php echo $td_class ?> fake-td" scope="row"><p
							class="title"><?php echo $okt['languages']->hasUniqueLanguage() ? $aWebsiteRouteInfos['basename'] : $sRouteName; ?></p></th>
					...
					<td class="<?php echo $td_class ?>"><?php echo $okt['languages']->hasUniqueLanguage() ? $aWebsiteRouteInfos['basepath'] : $aWebsiteRouteInfos['path']; ?></td>
	...
	<div id="tab_admin">
		...
		<table class="common routes_list">
			...
			<tr id="route_<?php echo $sRouteName ?>">
					<th class="<?php echo $td_class ?> fake-td" scope="row"><p
							class="title"><?php echo $okt['languages']->hasUniqueLanguage() ? $aAdminRouteInfos['basename'] : $sRouteName; ?></p></th>
					<td class="<?php echo $td_class ?>">
					<?php echo (isset($GLOBALS['okt_l10n']['c_a_route_name_'.$sShortName]) ? '<p><strong>'.$GLOBALS['okt_l10n']['c_a_route_name_'.$sShortName].'</strong></p>'  : '')?>
					<?php echo (isset($GLOBALS['okt_l10n']['c_a_route_desc_'.$sShortName]) ? '<p>'.$GLOBALS['okt_l10n']['c_a_route_desc_'.$sShortName].'</p>' : '')?>
				</td>
