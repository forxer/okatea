...
<?php $okt->languages->unique ? _e('c_a_config_website_title') : printf(__('c_a_config_website_title_in_%s'), $view->escape($aLanguage['title'])); ?><span
...
<p class="field" lang="<?php echo $aLanguage['code'] ?>">
	<label for="p_desc_<?php echo $aLanguage['code'] ?>">
<?php $okt->languages->unique ? _e('c_a_config_website_desc') : printf(__('c_a_config_website_desc_in_%s'), $view->escape($aLanguage['title'])); ?><span
		class="lang-switcher-buttons"></span>
	</label>
...
<?php else : ?>
	...
	<div class="two-cols">
		...
		<?php $okt->languages->unique ? _e('c_a_config_website_home_page_item') : printf(__('c_a_config_website_home_page_item_in_%s'), $view->escape($aLanguage['title'])); ?><span
				class="lang-switcher-buttons"></span>
			</label>
		...
		<?php $okt->languages->unique ? _e('c_a_config_website_home_page_details') : printf(__('c_a_config_website_home_page_details_in_%s'), $view->escape($aLanguage['title'])); ?><span
				class="lang-switcher-buttons"></span>
			</label>
