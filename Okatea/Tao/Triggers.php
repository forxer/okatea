...
class Triggers
{
	...
	/**
	 * Magic __set method. Alias de la méthode registerTrigger().
	 *
	...
	/**
	 * Magic __isset method. Alias de la méthode hasTrigger().
	 *
	 * @see self::hasTrigger()
	 */
	...
	/**
	 * Magic __get method. Alias de la méthode getTrigger().
	 *
	 * @see self::getTrigger()
	 */
