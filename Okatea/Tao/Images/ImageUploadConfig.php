...
class ImageUploadConfig
{
	...
	public function __construct($okt, $oImageUpload)
	{
		...
		$this->okt['l10n']->loadFile($this->okt['locales_path'] . '/%s/admin/images.config');
	...
	public function removeWatermak()
	{
		...
		return array_merge($this->oImageUpload->aConfig, array(
			'watermark_file' => ''
		));
	}
	...
	{
		$return = '<fieldset>' . '<legend>' . __('a_image_config_legend_base') . '</legend>' . 
	...
	{
		return '<fieldset>' . '<legend>' . __('a_image_config_legend_resize') . '</legend>' . 

		'<div class="three-cols">' . '<p class="field col"><label for="' . $this->sFormPrefix . 'width">' . __('a_image_config_maximum_width') . '</label>' . form::text($this->sFormPrefix . 'width', 10, 255, $this->oImageUpload->aConfig['width']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'height">' . __('a_image_config_maximum_height') . '</label>' . form::text($this->sFormPrefix . 'height', 10, 255, $this->oImageUpload->aConfig['height']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'resize_type">' . __('a_image_config_type_resize') . '</label>' . form::select($this->sFormPrefix . 'resize_type', self::getResizeTypes(), $this->oImageUpload->aConfig['resize_type']) . '</p>' . 
	...
	{
		return '<fieldset>' . '<legend>' . __('a_image_config_legend_thumbnails') . '</legend>' . 

		'<div class="three-cols">' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'width_min">' . __('a_image_config_thumbnails_width') . '</label>' . form::text($this->sFormPrefix . 'width_min', 10, 255, $this->oImageUpload->aConfig['width_min']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'height_min">' . __('a_image_config_thumbnails_height') . '</label>' . form::text($this->sFormPrefix . 'height_min', 10, 255, $this->oImageUpload->aConfig['height_min']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'resize_type_min">' . __('a_image_config_type_resize') . '</label>' . form::select($this->sFormPrefix . 'resize_type_min', self::getResizeTypes(), $this->oImageUpload->aConfig['resize_type_min']) . '</p>' . 

		'</div>' . 

		'<div class="three-cols">' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'width_min_2">' . __('a_image_config_thumbnails_width_2') . '</label>' . form::text($this->sFormPrefix . 'width_min_2', 10, 255, $this->oImageUpload->aConfig['width_min_2']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'height_min_2">' . __('a_image_config_thumbnails_height_2') . '</label>' . form::text($this->sFormPrefix . 'height_min_2', 10, 255, $this->oImageUpload->aConfig['height_min_2']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'resize_type_min_2">' . __('a_image_config_type_resize') . '</label>' . form::select($this->sFormPrefix . 'resize_type_min_2', self::getResizeTypes(), $this->oImageUpload->aConfig['resize_type_min_2']) . '</p>' . 

		'</div>' . 

		'<div class="three-cols">' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'width_min_3">' . __('a_image_config_thumbnails_width_3') . '</label>' . form::text($this->sFormPrefix . 'width_min_3', 10, 255, $this->oImageUpload->aConfig['width_min_3']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'height_min_3">' . __('a_image_config_thumbnails_height_3') . '</label>' . form::text($this->sFormPrefix . 'height_min_3', 10, 255, $this->oImageUpload->aConfig['height_min_3']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'resize_type_min_3">' . __('a_image_config_type_resize') . '</label>' . form::select($this->sFormPrefix . 'resize_type_min_3', self::getResizeTypes(), $this->oImageUpload->aConfig['resize_type_min_3']) . '</p>' . 

		'</div>' . 

		'<div class="three-cols">' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'width_min_4">' . __('a_image_config_thumbnails_width_4') . '</label>' . form::text($this->sFormPrefix . 'width_min_4', 10, 255, $this->oImageUpload->aConfig['width_min_4']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'height_min_4">' . __('a_image_config_thumbnails_height_4') . '</label>' . form::text($this->sFormPrefix . 'height_min_4', 10, 255, $this->oImageUpload->aConfig['height_min_4']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'resize_type_min_4">' . __('a_image_config_type_resize') . '</label>' . form::select($this->sFormPrefix . 'resize_type_min_4', self::getResizeTypes(), $this->oImageUpload->aConfig['resize_type_min_4']) . '</p>' . 

		'</div>' . 

		'<div class="three-cols">' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'width_min_5">' . __('a_image_config_thumbnails_width_5') . '</label>' . form::text($this->sFormPrefix . 'width_min_5', 10, 255, $this->oImageUpload->aConfig['width_min_5']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'height_min_5">' . __('a_image_config_thumbnails_height_5') . '</label>' . form::text($this->sFormPrefix . 'height_min_5', 10, 255, $this->oImageUpload->aConfig['height_min_5']) . ' ' . __('c_c_unit_px_s') . '</p>' . 

		'<p class="field col"><label for="' . $this->sFormPrefix . 'resize_type_min_5">' . __('a_image_config_type_resize') . '</label>' . form::select($this->sFormPrefix . 'resize_type_min_5', self::getResizeTypes(), $this->oImageUpload->aConfig['resize_type_min_5']) . '</p>' . 

		'</div>' . 

		'<p class="field"><label for="' . $this->sFormPrefix . 'square_size">' . __('a_image_config_dimensions_square') . '</label>' . form::text($this->sFormPrefix . 'square_size', 10, 255, $this->oImageUpload->aConfig['square_size']) . ' ' . __('c_c_unit_px_s') . '</p>' . 
	...
	{
		$return = '<fieldset>' . '<legend>' . __('a_image_config_legend_watermark') . '</legend>' . 

		'<div class="two-cols">' . '<div class="col">' . '<p class="field"><label for="' . $this->sFormPrefix . 'watermark_file">' . __('a_image_config_watermark_image') . '</label>' . form::file($this->sFormPrefix . 'watermark_file') . '</p>';
		...
		'<p class="field col"><label for="' . $this->sFormPrefix . 'watermark_position">' . __('a_image_config_watermark_position') . '</label>' . form::select($this->sFormPrefix . 'watermark_position', self::getWatermarkPositions(), $this->oImageUpload->aConfig['watermark_position']) . '</p>' . '</div>' . 
