...
class Pager
{
	...
	public function getLinks()
	{
		...
		for ($i = $this->index_group_start; $i <= $this->index_group_end; $i ++)
		{
			...
			{
				$htmlLinks .= sprintf($this->html_item, '<a' . ($i == 1 ? ' rel="nofollow"' : '') . ' class="' . $this->html_link_class . '" href="' . sprintf($this->page_url, $i) . '">' . $i . '</a>');
			}
		...
		$res = $htmlPrev . $htmlPrevGrp . $htmlLinks . $htmlNextGrp . $htmlNext;
	...
	{
		return "Elements per page ........... " . $this->nb_per_page . PHP_EOL . 'Pages per group.............. ' . $this->nb_pages_per_group . PHP_EOL . "Elements count .............. " . $this->nb_elements . PHP_EOL . 'Pages ....................... ' . $this->nb_pages . PHP_EOL . 'Groups ...................... ' . $this->nb_groups . PHP_EOL . PHP_EOL . 'Current page .................' . $this->env . PHP_EOL . 'Start index ................. ' . $this->index_start . PHP_EOL . 'End index ................... ' . $this->index_end . PHP_EOL . 'Current group ............... ' . $this->env_group . PHP_EOL . 'Group first page index ...... ' . $this->index_group_start . PHP_EOL . 'Group last page index ....... ' . $this->index_group_end;
	}
}
