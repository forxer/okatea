...
class Utilities
{
	 ...
	 *
	 * @param
	 *        	float	number		Le nombre à formater
	 * @param
	 *        	integer	dec			Le nombre de décimaux à afficher
	 * @return string
	 */
	 ...
	 *
	 * @param
	 *        	float	price		Le prix à formater
	 * @param
	 *        	float	taux		Le taux de conversion
	 * @param
	 *        	integer	dec			Le nombre de décimaux
	 * @return boolean
	 */
