...
<form
	...
	<div class="two-cols">
		<div class="col" id="sudo_part">
			...
			<p class="field">
				<label for="sudo_username" title="<?php _e('c_c_required_field') ?>"
					class="required"><?php _e('i_supa_username') ?></label>
			<?php echo form::text('sudo_username', 40, 255, $view->escape($aUsersData['sudo']['username'])) ?></p>

			<p class="field">
				<label for="sudo_password" title="<?php _e('c_c_required_field') ?>"
					class="required"><?php _e('i_supa_password') ?></label>
			<?php echo form::text('sudo_password', 40, 255, $view->escape($aUsersData['sudo']['password'])) ?></p>

			<p class="field">
				<label for="sudo_email" title="<?php _e('c_c_required_field') ?>"
					class="required"><?php _e('i_supa_email') ?></label>
