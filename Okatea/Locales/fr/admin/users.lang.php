...
# Admin
$GLOBALS['okt_l10n']['c_a_users_Add_user'] = 'Ajouter un utilisateur';
$GLOBALS['okt_l10n']['c_a_users_Groups'] = 'Groupes';
...
$GLOBALS['okt_l10n']['c_a_users_one_user_in_wait_of_validation'] = 'Il y a 1 utilisateur en attente de validation.';
$GLOBALS['okt_l10n']['c_a_users_%s_users_in_wait_of_validation'] = 'Il y a %s utilisateurs en attente de validation.';
$GLOBALS['okt_l10n']['c_a_users_list_Search'] = 'Recherche';
...
$GLOBALS['okt_l10n']['c_a_users_edit_native_group'] = 'Attention ! Il est déconseillé de modifier les groupes créés par le système.';
...
$GLOBALS['okt_l10n']['c_a_users_groups_title'] = 'Intitulé du groupe';
$GLOBALS['okt_l10n']['c_a_users_groups_title_in_%s'] = 'Intitulé du groupe en %s';
$GLOBALS['okt_l10n']['c_a_users_groups_description'] = 'Description du groupe';
$GLOBALS['okt_l10n']['c_a_users_groups_description_in_%s'] = 'Description du groupe en %s';
...
$GLOBALS['okt_l10n']['c_a_users_Site_side'] = 'Côté site';
$GLOBALS['okt_l10n']['c_a_users_Display_on_site_side'] = 'Affichage côté site';
$GLOBALS['okt_l10n']['c_a_users_Display_of_user_lists'] = 'Affichage des listes d’utilisateurs';
$GLOBALS['okt_l10n']['c_a_users_number_of_user_on_public_part'] = 'Nombre d’utilisateurs par page sur la partie publique';
$GLOBALS['okt_l10n']['c_a_users_Display_on_admin'] = 'Affichage sur l’interface d’administration';
$GLOBALS['okt_l10n']['c_a_users_Filters_users_list'] = 'Filtres d’affichage de la liste d’utilisateurs';
$GLOBALS['okt_l10n']['c_a_users_number_of_user_on_admin'] = 'Nombre d’utilisateurs par page sur l’interface d’administration';

# Configuration
$GLOBALS['okt_l10n']['c_a_users_General'] = 'Général';
$GLOBALS['okt_l10n']['c_a_users_users_custom_fields_enabled'] = 'Activation des champs personnalisés';
$GLOBALS['okt_l10n']['c_a_users_Activation_of_public_pages'] = 'Activation des pages publiques';
$GLOBALS['okt_l10n']['c_a_users_Enable_login_page'] = 'Activer la page d’identification';
$GLOBALS['okt_l10n']['c_a_users_Enable_registration_page'] = 'Activer la page d’inscription';
$GLOBALS['okt_l10n']['c_a_users_Enable_log_reg_page'] = 'Activer la page d’identification/d’inscription unifiée';
$GLOBALS['okt_l10n']['c_a_users_Enable_log_reg_page_note'] = 'vous ne pouvez activer cette page que si les pages d’identification et d’inscription sont activées';
$GLOBALS['okt_l10n']['c_a_users_Enable_page_forgotten_password'] = 'Activer la page de mot de passe oublié';
$GLOBALS['okt_l10n']['c_a_users_Enable_profile_page'] = 'Activer la page de profil';
...
$GLOBALS['okt_l10n']['c_a_users_Validation_of_registration_by_email'] = 'Validation des inscriptions par email';
...
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_gravatar'] = 'gravatar';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_gravatar_note'] = 'l’image Gravatar par défaut (ne varie pas en fonction de l’adresse email)';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_mm'] = 'l’homme mystère';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_mm_note'] = 'l’esquisse de la silhouette d’une personne dans un style de bande dessinée (ne varie pas en fonction de l’adresse email)';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_identicon'] = 'identicon';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_identicon_note'] = 'un motif géométrique basé sur l’adresse email';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_monsterid'] = 'monsterid';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_monsterid_note'] = 'un "monstre" généré avec des couleurs différentes, des visages, etc. en fonction de l’adresse email';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_wavatar'] = 'wavatar';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_wavatar_note'] = 'un visage dans un style de bande dessinée générée en fonction de l’adresse email';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_retro'] = 'retrot';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_retro_note'] = 'une image pixélisé dans un style 8-bit';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_blank'] = 'blank';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_blank_note'] = 'une image transparente PNG';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_404'] = 'erreur 404';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_default_image_404_note'] = 'ne charger aucune image, envoyer à la place une réponse HTTP erreur 404 (Fichier introuvable)';

$GLOBALS['okt_l10n']['c_a_users_config_gravatar_rating'] = 'Classification maximum des Gravatar';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_rating_note'] = 'Choisissez le niveau maximum de classification des Gravatar à afficher.';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_rating_g'] = 'G';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_rating_g_note'] = 'Un Gravatar classifié en catégorie ‘G’ convient à tout type de site, et à toute audience. Recommandé pour la majorité des sites web.';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_rating_pg'] = 'PG';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_rating_pg_note'] = 'Un Gravatar classifié en catégorie ‘PG’ peut contenir des jurons, ou des images potentiellement choquantes représentant de la violence légère ou des individus habillés de manière provoquante.';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_rating_r'] = 'R';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_rating_r_note'] = 'Un Gravatar classifié en catégorie ‘R’ comprend des images choquantes représentant de la violence intense, de la nudité, ou de l’emploi de drogues dures.';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_rating_x'] = 'X';
$GLOBALS['okt_l10n']['c_a_users_config_gravatar_rating_x_note'] = 'Un Gravatar classé en catégorie ‘X’ comprend des images extrêmes ou dérangeantes à cause de représentations crues de nature sexuelle, ou de violence extrême.';
...
$GLOBALS['okt_l10n']['c_a_users_config_tpl_login'] = 'Modèles de la page du formulaire d’identification';
$GLOBALS['okt_l10n']['c_a_users_config_tpl_login_register'] = 'Modèles de la page des formulaires d’identification/d’inscription unifiée';
